class FixedArrayBullet extends Phaser.Scene {
    constructor() {
        ...
        this.timer = 0;      // record a score as a class variable
    ...
    create() {
        ...
        document.getElementById('description').innerHTML = '<h2>Gator Gamble: Level 2</h2><br>A: left // D: right // Space: fire/emit - Reach 1,250 points to win!'
        ...
        for (let du of this.ducks){
            if (this.timer % du.shootTimer == 0){
                my.sprite.duckbullet.push(this.add.sprite(
                    du.x, du.y-(du.displayHeight/2), "duckSq").setScale(0.125));
